...
import { ETHEREUM_CHAIN_CONFIG, ARBITRUM_CHAIN_CONFIG, NETWORK_CONTRACTS } from "@/lib/constants"
          ...
          <TabsContent value="fee" className="space-y-4">
            <div>
              ...
              <div className="space-y-4">
                ...
                <button className="w-full px-6 py-3 text-lg font-semibold bg-orange-500 hover:bg-orange-600 text-white rounded-lg transition-colors">
                  Collect Fees
                </button>
              </div>
            </div>
