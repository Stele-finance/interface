export const en = {
  ...
  amount: "Amount",
  areYouReadyToBeLegend: "Anyone can become an investment legend, even without credit or bank accounts",
  back: "Back",
  ...
  cancel: "Cancel",
  canceled: "Canceled",
  carveYourNameOnBlockchain: "Investment freedom that starts with just one wallet",
