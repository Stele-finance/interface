export const en = {
  ...
  arbitrumNotSupportedByPhantom: "Arbitrum is not supported by Phantom wallet.",
  back: "Back",
  ...
  connectPhantomWalletToDelegate: "Please connect your Phantom wallet to delegate",
  ...
  perToken: "per token",
  phantomDoesNotSupportArbitrum: "Phantom wallet does not support Arbitrum network. Please disconnect and connect with MetaMask to access Arbitrum.",
  ...
  pleaseUseMetaMaskForArbitrum: "Please use MetaMask to access Arbitrum network.",
  portfolio: "Portfolio",
