export const en = {
  ...
  amount: "Amount",
  availableByLinkingWallet: "Available by linking with MetaMask wallet",
  back: "Back",
  backToProposals: "Back to Proposals",
  balance: "Balance",
  balanceUnavailable: "Balance unavailable",
  balanceCheckFailed: "Balance check failed",
  becomeAnInvestmentLegend: "Become an investment legend",
  ...
  buy: "Buy",
  byConnectingWalletPrefix: "By connecting a wallet, you agree to Stele Finance'",
  byConnectingWalletMiddle: "and consent to its",
  ...
  doc: "Doc",
  duration: "Duration",
  earnPrizesWithSkill: "Earn fee with investment skills",
  empty: "Empty",
  estimate: "Estimate",
  end: "End",
  endDate: "End Date",
  ...
  readOurTermsAndConditions: "Read our terms and conditions",
  ...
  time: "Time",
  tradingCompetition: "Prove investment skills through fund managing",
  ...
  weekShort: "w",
  weekly: "Weekly",
  winAndGetPrizeMoney: "Win and get prize money",
  withdraw: "Withdraw",
