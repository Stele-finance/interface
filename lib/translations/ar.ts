export const ar = {
  ...
  againstVotes: "ضد",
  all: "الكل",
  allFunds: "جميع الصناديق",
  allProposals: "جميع المقترحات",
  alreadyActive: "نشط بالفعل",
  alreadyVoted: "تم التصويت بالفعل",
  alwaysAvailable: "متوفر على مدار 24/7 في أي وقت وأي مكان للاستثمار",
  amount: "المبلغ",
  areYouReadyToBeLegend: "كن أسطورة في الاستثمار بالعملات المشفرة",
  back: "العودة",
  ...
  buy: "شراء",
  byConnectingWalletPrefix: "من خلال توصيل المحفظة، فإنك توافق على",
  byConnectingWalletMiddle: "لـ Stele Finance وتوافق على",
  byConnectingWalletSuffix: " الخاصة بها.",
  cancel: "إلغاء",
  canceled: "ملغى",
  carveYourNameOnBlockchain: "حرية الاستثمار التي تبدأ مع البلوك تشين",
  castYourVote: "أدلِ بصوتك",
  complexBankProcedures: "إجراءات فتح الحساب المصرفي المعقدة والأوراق",
  createOwnFund: "إنشاء وتشغيل صندوقك الخاص",
  challenge: "التحدي",
  ...
  challengeDescription: "انضم إلى تحدي مهارات الاستثمار بالعملات المشفرة ويتم توزيع الجوائز على المراكز 1-5 الأولى.",
  challenges: "التحديات",
  ...
  entryFeeRequired: "رسوم الدخول مطلوبة",
  entryFeeRequiredDesc: "يتطلب رسوم دخول صغيرة للمشاركة في التحدي",
  errorClaimingRewards: "خطأ في استلام المكافآت",
  ...
  fund: "صندوق",
  fundManagerDescription: "أثبت مهاراتك الاستثمارية كمدير صندوق أو استثمر مع مديرين موثوقين.",
  funds: "صناديق",
  ...
  globalInvestors: "جذب التمويل مباشرة من المستثمرين العالميين",
  github: "Github",
  ...
  highMinimumInvestment: "مبالغ استثمار دنيا عالية ومتطلبات أهلية للمشاركة في الصناديق",
  ...
  instantAccountCreation: "إنشاء حساب استثمار فوري دون KYC معقد",
  ...
  investor: "المستثمر",
  investorsComeToyou: "بمجرد التحقق، سيأتي المستثمرون إليك",
  investmentChallenge: "مسابقة الاستثمار",
  join: "انضم",
  ...
  legalAndPrivacy: "القانونية والخصوصية",
  ...
  nft: "NFT",
  nftCertification: "اعتماد قدراتك الاستثمارية من خلال إصدار NFT",
  nftCollection: "حول الأداء إلى NFT للجمع مدى الحياة",
  nftMintedSuccessfully: "تم سك NFT بنجاح",
  noNFTsFound: "لم يتم العثور على NFTs",
  noNFTsFoundDescription: "شارك في التحديات لكسبها!",
  networkSwitchFailed: "فشل تبديل الشبكة",
  networkSwitched: "تم تبديل الشبكة",
  next: "التالي",
  no: "لا",
  noActiveProposalsFound: "لم يتم العثور على مقترحات نشطة.",
  noActiveFundsAvailable: "لا توجد صناديق نشطة متاحة.",
  ...
  noCreditAccess: "عدم القدرة على الوصول للخدمات المالية لمن ليس لديهم تاريخ ائتماني",
  noDataAvailable: "لا توجد بيانات متاحة",
  noFundsFound: "لم يتم العثور على صناديق",
  ...
  performance: "الأداء",
  performanceProof: "إثبات الأداء",
  performanceProofDesc: "أثبت أداء الاستثمار بسجلات البلوك تشين واجذب المستثمرين",
  period: "فترة",
  perToken: "لكل رمز",
  ...
  proposalCanceled: "تم إلغاء هذا المقترح",
  proposalDefeated: "تم رفض هذا المقترح",
  proposalExecuted: "تم تنفيذ هذا المقترح",
  proposalExpired: "انتهت صلاحية هذا المقترح",
  proposalQueuedReadyForExecution: "المقترح في قائمة الانتظار وجاهز للتنفيذ",
  proposalSucceededReadyToQueue: "انتهت فترة التصويت - نجح المقترح وهو جاهز لدخول قائمة الانتظار",
  proposalTitle: "عنوان المقترح *",
  proposalVotingNotStarted: "لم تبدأ فترة التصويت بعد",
  proposer: "المقترح",
  proposals: "المقترحات",
  ...
  readOurTermsAndConditions: "اقرأ الشروط والأحكام الخاصة بنا",
  readyToVote: "جاهز للتصويت",
  recentActivity: "النشاط الأخير",
  realtimeTransparency: "الشفافية في الوقت الفعلي",
  realtimeTransparencyDesc: "عرض تاريخ الاستثمار والمحفظة في الوقت الفعلي",
  ...
  returnCompetition: "منافسة العوائد",
  returnCompetitionDesc: "أفضل 1-5 مستخدمين من حيث عوائد الاستثمار يفوزون بجوائز",
  requestCancelled: "تم إلغاء الطلب",
  rewardClaimed: "تم استلام المكافآت!",
  rewardClaimCancelled: "تم إلغاء طلب استلام المكافآت بواسطة المستخدم",
  rewardClaimTransactionSent: "تم إرسال معاملة استلام المكافآت إلى الشبكة.",
  ...
  rewards: "المكافآت",
  rewardsClaimedSuccessfully: "تم استلام مكافآت التحدي بنجاح!",
  score: "النقاط",
  secondPlaceDesc: "نسبة الجائزة للمركز الثاني",
  secondPlaceLabel: "المركز الثاني (%)",
  seconds: "ثواني",
  secondShort: "ث",
  secureFundManagement: "إدارة أموال آمنة",
  secureFundManagementDesc: "يمكن للمستثمرين فقط إيداع/سحب أموالهم الخاصة للأمان",
  ...
  showing: "عرض",
  singleWalletStart: "بمحفظة واحدة فقط",
  skillAsAsset: "مهاراتك تصبح أصولك",
  sixMonths: "6 أشهر",
  ...
  state: "الحالة",
  status: "الحالة",
  steleInnovation: "الابتكار الذي تقدمه Stele",
  ...
  thirdWorldInfrastructure: "نقص البنية التحتية المالية في البلدان النامية",
  ...
  transparentVerification: "التحقق الشفاف من المهارات",
  trueFreedom: "هذه هي الحرية المالية الحقيقية.",
  ...
  updated: "محدث",
  user: "المستخدم",
  userBenefits: "الفوائد الحقيقية من منظور المستخدم",
  users: "المستخدمون",
  ...
  virtualTradingChallenge: "التحدي",
  viewOnEtherscan: "عرض على Etherscan",
  viewOnExplorer: "عرض على المستكشف",
  viewProposal: "عرض المقترح",
  viewYourPerformanceNFTs: "عرض NFTs الأداء المكتسبة من التحديات",
  vote: "صوت",
  voteAgainst: "صوت ضد",
  ...
  yes: "نعم",
  youHaventCreatedAnyFunds: "لم تقم بإنشاء أي صناديق بعد."
} as const; 
