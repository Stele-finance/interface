...
export function middleware(request: NextRequest) {
  ...
  const cspHeader = `
    ...
    connect-src 'self' https://static.ads-twitter.com https://ads-twitter.com https://ads-api.twitter.com https://analytics.twitter.com https://*.infura.io https://mainnet.infura.io https://arbitrum-mainnet.infura.io https://*.etherscan.io https://api.etherscan.io https://api-arbitrum.arbiscan.io https://*.uniswap.org https://*.thegraph.com https://gateway.thegraph.com https://api.studio.thegraph.com https://arb1.arbitrum.io https://*.walletconnect.com https://*.walletconnect.org https://rpc.walletconnect.com https://rpc.walletconnect.org https://relay.walletconnect.com https://relay.walletconnect.org wss://*.infura.io wss://*.walletconnect.com wss://*.walletconnect.org;
